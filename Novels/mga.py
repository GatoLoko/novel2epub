...
volumes = {
    "1": Volume("1 - Battle of dignity", 1, 264),
    "2": Volume("2 - Sweeping through the Nine Provinces", 265, 548),
    "3": Volume("3 - Eastern Sea region", 549, 1004),
    "4": Volume("4 - A new journey", 1005, 1558),
    "5": Volume("5 - Battle for Overlord", 1559, 2148),
    "6": Volume("6 - Hundred refining ordinary realm", 2149, 2672),
    "7": Volume("7 - Return of the discarded child", 2673, 3108),
    "8": Volume("8 - Battle of prophecy", 3109, 3764),
    "9": Volume("9 - Birth of Asura", 3765, 4971),
    "10": Volume("10 - Hidden Dragon Martial Sect", 4600, 4601),
...
def genlist(start: int, end: int) -> list[str]:
    ...
    for i in range(start, end + 1):
        if i == 1632:
            ...
            url = f"{origin}mga-chapter-1632-01"
            chapterlist.append(url)
            url = f"{origin}mga-chapter-1632-02"
            chapterlist.append(url)
        # elif i == 4452:
