...
volumes = {
    "1": Volume("1 - Starting from scratch", 1, 248),
    "2": Volume("2 - Rise of heroes", 249, 500),
    "3": Volume("3 - The Grandmaster", 501, 748),
    "4": Volume("4 - The chase to the top", 749, 1000),
    "5": Volume("5", 1001, 1007),
    "6": Volume("6 - END", 1251, 1251),
