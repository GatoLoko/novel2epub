...
volumes = {'1': Volume('1', 0, 100),
           ...
           '8': Volume('8', 701, 800),
           '9': Volume('9', 801, 900),
           '10': Volume('10', 901, 970),
           #
           '11': Volume('11', 1001, 1001),
           '12': Volume('12', 1101, 1001),
           '13': Volume('13', 1201, 1001),
           '14': Volume('14', 1301, 1001),
           '15': Volume('15', 1401, 1001),
           '16': Volume('16', 1501, 1001),
           '17': Volume('17', 1601, 1001),
           '18': Volume('18', 1701, 1001),
           '19': Volume('19', 1801, 1001),
           '20': Volume('20', 1901, 1901),
           '21': Volume('21', 2001, 2001),
           '22': Volume('22', 2101, 2101),
           '23': Volume('23', 2201, 2201),
           '24': Volume('24', 2301, 2301),
           # As of Jun 2019, there are 2382+ in the original novel
           }
