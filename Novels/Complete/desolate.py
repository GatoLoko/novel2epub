...
volumes = {
    ...
    "6": Volume(
        "6 - Breaking through the cocoon, becoming a butterfly",
        6,
        38,
    ),
    ...
    "16": Volume("16 - The Nihilum zone", 16, 25),
    "17": Volume("17 - Celestial immortal", 17, 27),
    "18": Volume("18 - Pure Yang", 18, 56),
    "19": Volume("19 - Empyrean God", 19, 55),
    "20": Volume("20 - Jindan upgrade", 20, 37),
    "21": Volume("21 - The Bloodlotus blooms", 21, 37),
    "22": Volume("22 - True God", 22, 29),
    "23": Volume("23 - Endwar", 23, 35),
    "24": Volume("24 - The Starlord of Fogstone", 24, 49),
    "25": Volume("25 - Novessence Thunder", 25, 40),
    "26": Volume("26 - World level", 26, 58),
    "27": Volume("27 - Twelve palaces", 27, 29),
    "28": Volume("28 - Archaeus region", 28, 48),
    "29": Volume("29 - Daolord", 29, 42),
    "30": Volume("30 - Ancient cultivator", 30, 36),
    "31": Volume("31 - Starflow river", 31, 24),
    "32": Volume("32 - Waveshift realm", 32, 28),
    "33": Volume("33 - Crimsonware temple", 33, 23),
    "34": Volume("34 - The stone hellephant wall", 34, 32),
    "35": Volume("35 - The Aeonian race", 35, 20),
    "36": Volume("36 - Daolord of the Fourth Step", 36, 30),
    "37": Volume("37 - Flamewing God", 37, 31),
    "38": Volume("38 - Daomerge", 38, 43),
    "39": Volume("39 - Nuwa", 39, 23),
    "40": Volume("40 - The five Autarchs", 40, 20),
    "41": Volume("41 - The Daoguard tower", 41, 26),
    "42": Volume("42 - The five Truncheon chapters", 42, 21),
    "43": Volume("43 - Final fate", 43, 25),
    "44": Volume("44 - The Dusk war", 44, 29),
    "45": Volume("45 - The fragrance of the Plum Blossom", 45, 18),
}
...
def genlist(start, end):
    # In this module we break the rules and use "start" as book number, all
    # book chapters are numbered from 1.
    chapterlist = []
    for i in range(1, end + 1):
        url = f"{origin}de-book{start}-chapter-{i}"
        if i == 18 and start == 45:
            url = f"{origin}de-afterword"
